...
| `--mm-scratch-name` / `--mm-scratch-name-style` | `var(--mm-accent)` / `italic` | The scratchpad buffer's "Scratchpad file" placeholder name in the toolbar and its file tab (PRD 023 Req 7; the token name keeps its original spelling, issue #244) |
