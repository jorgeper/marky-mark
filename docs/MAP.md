...
| [SPEC23](specs/SPEC23.md) | SPEC23: Marky Mark v23 — editing trio: mirrored selection, vim nav mode, markdown highlighting | `src/App.tsx`, `src/components/Editor.tsx`, `src/components/livePreview.ts`, `src/lib/codeSelection.ts`, `src/lib/selectionMap.ts`, `src/lib/settings.ts`, `src/lib/vimnav.ts`, `src/platform/browser.ts`, `src/styles.css` | `tests/e2e/editor.spec.ts`, E150, `tests/e2e/live-preview.spec.ts`, E61, E265 |
