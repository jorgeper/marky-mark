...
| [SPEC36](specs/SPEC36.md) | SPEC36: Marky Mark v36 — multiple open files (sidebar tabs) | `src/App.tsx`, `src/components/FolderPanel.tsx`, `src/lib/folderTree.ts`, `src/lib/hotkeys.ts`, `src/lib/menuSpec.ts`, `src/lib/openFiles.ts`, `src/lib/settings.ts`, `src/styles.css` | E27, E96, E98, `tests/e2e/folder-tree.spec.ts` |
