...
| [SPEC12](specs/SPEC12.md) | SPEC12: Marky Mark v12 — native desktop menus, chromeless desktop window | `src/App.tsx`, `src/components/SettingsPanel.tsx`, `src/lib/commands.ts`, `src/lib/menuSpec.ts`, `src/platform/browser.ts`, `src/platform/tauri.ts`, `src/platform/types.ts` | E94, E95, E284, E47, E49, E133, E101, E258 |
...
| [SPEC36](specs/SPEC36.md) | SPEC36: Marky Mark v36 — multiple open files (sidebar tabs) | `src/App.tsx`, `src/components/FileTabStrip.tsx`, `src/components/FolderPanel.tsx`, `src/lib/fileTabs.ts`, `src/lib/folderTree.ts`, `src/lib/hotkeys.ts`, `src/lib/menuSpec.ts`, `src/lib/openFiles.ts`, `src/styles.css` | E27, E267, E271, E272, E274, E275, E292, E296, E298, E307, `tests/e2e/file-tabs.spec.ts`, E96, E98, E305, `tests/e2e/folder-tree.spec.ts`, E175 |
...
| [SPEC40](specs/SPEC40.md) | SPEC40: Marky Mark v40 — the grid is how tables look: no mode, one global view | `src/App.tsx`, `src/components/Editor.tsx`, `src/components/imageView.ts`, `src/components/livePreview.ts`, `src/components/tableMode.ts`, `src/lib/imageResize.ts`, `src/lib/livePreview.ts`, `src/lib/settings.ts`, `src/lib/smartEdit.ts`, `src/lib/tableEdit.ts` | E307, E107 |
| [SPEC41](specs/SPEC41.md) | SPEC41: Marky Mark v41 — images render in the editor: one global view, chips to resize | `src/App.tsx`, `src/components/Editor.tsx`, `src/components/imageView.ts`, `src/lib/fenceRenderers.ts`, `src/lib/imageResize.ts`, `src/lib/markdown.ts`, `src/lib/settings.ts`, `src/lib/smartEdit.ts`, `src/styles.css` | E77, E107 |
