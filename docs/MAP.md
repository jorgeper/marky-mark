...
| [SPEC22](specs/SPEC22.md) | SPEC22: Marky Mark v22 — New File v2: the untitled buffer | `src/App.tsx`, `src/lib/menuSpec.ts`, `src/lib/savePicker.ts` | E72 |
...
| [SPEC36](specs/SPEC36.md) | SPEC36: Marky Mark v36 — multiple open files (sidebar tabs) | `src/App.tsx`, `src/components/FileTabStrip.tsx`, `src/components/FolderPanel.tsx`, `src/lib/fileTabs.ts`, `src/lib/folderTree.ts`, `src/lib/hotkeys.ts`, `src/lib/menuSpec.ts`, `src/lib/openFiles.ts`, `src/styles.css` | E27, E267, E271, E272, E274, E275, `tests/e2e/file-tabs.spec.ts`, E96, E98, `tests/e2e/folder-tree.spec.ts`, E175 |
