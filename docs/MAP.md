...
| [SPEC12](specs/SPEC12.md) | SPEC12: Marky Mark v12 — native desktop menus, chromeless desktop window | `src/App.tsx`, `src/components/SettingsPanel.tsx`, `src/lib/commands.ts`, `src/lib/menuSpec.ts`, `src/platform/browser.ts`, `src/platform/tauri.ts`, `src/platform/types.ts` | E94, E95, E47, E49, E133, E101, E255 |
...
| [SPEC34](specs/SPEC34.md) | SPEC34: Marky Mark v34 — the folder sidebar | `src/App.tsx`, `src/components/FolderPanel.tsx`, `src/lib/folderOps.ts`, `src/lib/folderTree.ts`, `src/lib/menuSpec.ts`, `src/lib/settings.ts`, `src/platform/browser.ts`, `src/platform/hosted.ts`, `src/platform/tauri.ts`, `src/platform/types.ts`, `src/styles.css` | E6, E257 |
