...
| [SPEC4](specs/SPEC4.md) | SPEC4: Markimark v4 — vanishing toolbar, tabbed settings, text-only zoom, clean start | `src/App.tsx`, `src/lib/settings.ts`, `src/styles.css` | E24 |
...
| [SPEC10](specs/SPEC10.md) | SPEC10: Marky Mark v10 — open-source alpha: semver, CI/CD releases, About, license | `src/components/AboutDialog.tsx`, `src/styles.css`, `src/vite-env.d.ts` | E45 |
