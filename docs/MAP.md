...
| [SPEC11](specs/SPEC11.md) | SPEC11: Marky Mark v11 — network isolation guarantee & security hardening | `src/App.tsx`, `src/components/AboutDialog.tsx`, `src/components/imageView.ts`, `src/components/livePreview.ts`, `src/lib/markdown.ts`, `src/lib/themes.ts`, `src/platform/tauri.ts`, `src/platform/types.ts`, `src/styles.css` | E121, E46 |
