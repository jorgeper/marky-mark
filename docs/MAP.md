...
| [SPEC18](specs/SPEC18.md) | SPEC18: Marky Mark v18 — static HTML export, working PDF | `src/App.tsx`, `src/lib/exportDoc.ts`, `src/lib/printDoc.ts`, `src/platform/tauri.ts`, `src/styles.css` | E63 |
