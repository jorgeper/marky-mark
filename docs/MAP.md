...
| [SPEC30](specs/SPEC30.md) | SPEC30: Marky Mark v30 — Find, reopen-on-launch, crash-safe drafts | `src/App.tsx`, `src/components/Editor.tsx`, `src/components/FindBar.tsx`, `src/lib/drafts.ts`, `src/lib/menuSpec.ts`, `src/styles.css` | E288 |
