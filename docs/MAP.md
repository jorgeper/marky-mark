...
| [SPEC40](specs/SPEC40.md) | SPEC40: Marky Mark v40 — the grid is how tables look: no mode, one global view | `src/App.tsx`, `src/components/Editor.tsx`, `src/components/imageView.ts`, `src/components/livePreview.ts`, `src/components/tableMode.ts`, `src/lib/codeBlockSpans.ts`, `src/lib/imageResize.ts`, `src/lib/livePreview.ts`, `src/lib/settings.ts`, `src/lib/smartEdit.ts`, `src/lib/tableEdit.ts` | E307, E107 |
| [SPEC41](specs/SPEC41.md) | SPEC41: Marky Mark v41 — images render in the editor: one global view, chips to resize | `src/App.tsx`, `src/components/Editor.tsx`, `src/components/codeBlockView.ts`, `src/components/imageView.ts`, `src/lib/codeBlockSpans.ts`, `src/lib/imageResize.ts`, `src/lib/markdown.ts`, `src/lib/settings.ts`, `src/lib/smartEdit.ts`, `src/styles.css` | E77, E107 |
