...
| [SPEC23](specs/SPEC23.md) | SPEC23: Marky Mark v23 — editing trio: mirrored selection, vim nav mode, markdown highlighting | `src/App.tsx`, `src/components/Editor.tsx`, `src/components/livePreview.ts`, `src/lib/selectionMap.ts`, `src/lib/settings.ts`, `src/lib/vimnav.ts`, `src/platform/browser.ts`, `src/styles.css` | E61 |
