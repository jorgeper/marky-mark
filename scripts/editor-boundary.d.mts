/** Type surface of editor-boundary.mjs for the unit suite (U1095–U1100). */
...
export declare function appImportViolation(spec: string): string | null;
export declare function lintEditorSource(source: string, fileDirRel: string): BoundaryFinding[];
export declare function lintAppSource(source: string): BoundaryFinding[];
