...
describe('Issue #318: callout spans in the edit pane', () => {
  test('U1251: computeCalloutViews — the five kinds with their line ranges and marker spans; the marker line reveals on caret; non-callouts and nested quotes emit nothing', () => {
    const doc = [
      'intro',
      '',
      '> [!NOTE]',
