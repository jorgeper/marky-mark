...
describe('PRD 012 Req 6 (issue #300): the heading-text caret column', () => {
  test('U1281: ATX headings land after the markers and their whitespace; setext and plain lines after indentation; nested headings after their container prefix', () => {
