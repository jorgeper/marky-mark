...
describe('PRD 027 Req 12/13 (issue #366) bridge edit primitives', () => {
  test('U1414: replaceRange lands one transaction — a single undo restores the original text, the caret sits after the inserted text', () => {
  ...
  test('U1415: offsets clamp into the document and reorder — a stale or reversed range never throws', () => {
  ...
  test('U1416: replaceRange never focuses the view; viewportLines is a positive line count whatever the measurement', () => {
