...
describe('Issue #318: GitHub-alert callouts render as tinted blocks in the preview', () => {
  test('U1250: the five kinds become .mm-callout blockquotes with a title row, the marker gone, the line stamp kept; case-insensitive; other blockquotes untouched', async () => {
