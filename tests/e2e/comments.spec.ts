...
test('E620: issue #343 — preview-only: after opening from the sidebar and a round trip through edit mode, selecting plain text with the tab strip up shows the Marky Mark button clear of the toolbar and the strip, with exactly the Comment and Highlight rows', async ({
  page,
}) => {
...
test('E622: issue #343 — the desktop shim renders no copy-link anywhere: a click-activated comment or highlight grows the Marky Mark button alone (its menu from the record\'s context), and the editor caret inside either paints no margin control', async ({
  page,
}) => {
