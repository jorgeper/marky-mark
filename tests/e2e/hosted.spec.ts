...
test('E558: the Open Workspace dialog lists the signed-in user’s most recently opened workspaces first, and opening another moves it to the top', async ({
  page,
  request,
}) => {
