...
test('E446: a comment card carries a copy-link that copies the file URL plus #hl-<id>, on open and resolved cards alike', async ({
  page,
  request,
}) => {
...
test('E447: visiting #hl-<comment id> lands centred and flashed AND activates the comment — pane open, card active', async ({
  page,
  request,
}) => {
...
test('E448: a #hl-<id> naming no record keeps the one dismissible miss notice and activates nothing', async ({
  page,
  request,
}) => {
