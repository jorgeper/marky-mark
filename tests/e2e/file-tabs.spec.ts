...
import { dirtyActiveDoc, freshApp, fsRead, fsWrite, openNotesRoot, openSettings, seedFolders } from './helpers';
...
/** Flip the Appearance checkbox and close the dialog again. */
