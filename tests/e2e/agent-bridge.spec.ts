...
test('E650: bridge edits land as one undo unit, dirty the document, never autosave, are refused on a stale revision, and save through the app', async ({
  page,
}) => {
...
test('E651: apply_format is one undo step, replace_range takes canonical offsets, scroll targets resolve, and a preview-mode tool answers a typed failure', async ({
  page,
}) => {
