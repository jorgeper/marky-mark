...
describe('SPEC11 §4 (issue #268): in-document fragment links resolve through the Req 18 anchors', () => {
  test('U1206: previewLinkAction — a fragment resolves to its heading line through the ONE slug table, duplicates keep their own occurrence, a percent-encoded fragment decodes, an unmatched one is a graceful miss, and external/inert keep the SPEC11 §4 parity contract', () => {
