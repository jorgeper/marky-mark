...
describe('Issue #343 — the preview button for a click-activated record with the selection collapsed', () => {
  ...
  test('U1361: the active record builds the rows from its own context — Delete Comment for a comment, recolor + Remove Highlight for a highlight, insert rows disabled; no active or unpainted record closes as before', () => {
