...
describe('Issue #178 collapsed-caret mapping', () => {
  test('U971: sourceCaretForRendered — a mid-word caret lands at the exact source offset, through stripped markers and repeated words', () => {
  ...
  test('U972: sourceCaretForRendered — end-of-word affinity, punctuation runs via the flat prefix, invisible blocks null', () => {
  ...
  test('U973: sourceCaretForRendered — fence bodies map verbatim and the nth count spans mid-word hits', () => {
    const src = '```py\nvalue = a * b\n```\n';
    const rendered = 'value = a * b\n';
