...
describe('PRD 007 Req 11 (issue #312): recently used workspaces lead the Open Workspace list', () => {
  ...
  it('U1273: recently used ids come first in the given order, then the rest most recently modified', () => {
  ...
  it('U1274: a recent id the listing does not contain is skipped without a row or a gap', () => {
  ...
  it('U1275: recency-first ordering is applied before the row cap, so a used-but-old workspace stays visible', () => {
  ...
  it('U1270: with a query the match set is unchanged and, among equal scores, recent use precedes modified', () => {
    const named = [
      listing({ id: 'a', name: 'Design docs', modified: '2026-08-01T00:00:00.000Z' }),
      listing({ id: 'b', name: 'Release notes', modified: '2026-08-05T00:00:00.000Z' }),
      listing({ id: 'c', name: 'Design system', modified: '2026-08-03T00:00:00.000Z', access: false }),
