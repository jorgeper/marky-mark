...
describe('PRD 023 §5 click hit resolution — the kind-aware pick (issue #285)', () => {
  test('U1131: a comment wins over a highlight covering the same click, whatever order the candidates arrive in', () => {
  ...
  test('U1132: a highlight alone resolves to itself — kind preference never erases the only record under the click', () => {
  ...
  test('U1133: among overlapping comments the innermost wins — pinned as the greatest anchor.start, candidate order breaking a tie', () => {
  ...
  test('U1134: ids naming no record are ignored; a set with nothing hostable resolves to null', () => {
