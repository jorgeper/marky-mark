...
describe('Issue #308 editorHighlights setting', () => {
  ...
  test('U1276: editorHighlights defaults true, a stored false round-trips, malformed falls back, user-scoped', () => {
...
describe('PRD 027 Req 1: the Agent bridge experiment ships off', () => {
  test('U1405: agentBridge defaults to false, is U-scoped, tolerates a non-boolean as off, and round-trips', () => {
