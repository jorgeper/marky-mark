...
// operator at deploy time. Same stance as the GitHub App section above —
// absent unless configured, refused by name when half-configured — with one
// extra rule of its own: no refusal may quote the key.
