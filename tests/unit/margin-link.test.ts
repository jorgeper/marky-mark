...
describe('Issue #343 margin copy-link — which record the control addresses', () => {
  test('U1362: the pick is the PRD 023 §5 kind-aware rule over the ids under the head, labelled for its kind; plain text picks nothing', () => {
  ...
  test('U1363: the preview asks with the painted ranges covering a selection start — document order, end exclusive, unpainted records never candidates', () => {
