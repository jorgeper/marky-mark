...
describe('PRD 023 §13 preview selection button geometry (issues #306, #343)', () => {
  test('U1362: centred on the anchor line in the padding column; beneath a level copy-link when one is grafted; clamped below the toolbar floor and the tab strip', () => {
