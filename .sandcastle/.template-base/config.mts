...
export const VERIFY_COMMANDS: string[] = []; // TODO(sandcastle): verify commands not set — run the sandcastle-customize skill from your coding agent (or fill this in), then delete this comment.;
